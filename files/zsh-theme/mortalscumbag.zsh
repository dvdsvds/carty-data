---
name: Mortal Scumbag
description: SSH 여부와 git 브랜치를 두 줄로 표시하는 굵은 컬러 테마
category: zsh-theme
preview_colors: ["#75507b", "#c4a000", "#4e9a06"]
provides:
    aliases: []
    functions: ["_toolbox_prompt_info", "my_current_branch", "my_git_prompt", "ssh_connection"]
depends_on: []
---
