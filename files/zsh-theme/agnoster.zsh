---
name: Agnoster
description: Powerline 스타일의 구간형(segmented) 테마 — 배경색 블록으로 디렉터리/git 상태 표시 (Powerline 폰트 필요)
category: zsh-theme
preview_colors: ["#3465a4", "#2e3436", "#4e9a06"]
provides:
    aliases: []
    functions: ["build_prompt", "prompt_segment", "prompt_dir", "prompt_git", "prompt_end", "prompt_status", "prompt_context", "prompt_virtualenv", "prompt_aws", "prompt_bzr", "prompt_hg", "prompt_terraform", "prompt_git_relative", "git_toplevel"]
depends_on: []
---
